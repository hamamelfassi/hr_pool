...
Education, employment history, skills, and languages are no longer part of the first public employment application payload.

The Odoo child models remain available for manual/internal enrichment and future prefilled enrichment forms, but the initial Fillout/Zite -> n8n -> Odoo create payload should not write:
...
Commitment lines may remain in the initial payload if they represent required initial declarations or availability commitments.

### Deferred enrichment mappings — not used by initial intake
